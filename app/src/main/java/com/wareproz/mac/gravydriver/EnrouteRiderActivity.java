...
public class EnrouteRiderActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, LocationListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    Button contact, navigate, confirmArrival;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enroute_rider);
        ...
        confirmArrival = (Button) findViewById(R.id.confirmArrival);
        ...
        txtPickupAddress.setText(pickup_address);
        ...
        navigate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String format = "geo:0,0?q=" + lat + "," + lng + "," + "," + pickup_address;
    ...
    private class DriverArrived extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(EnrouteRiderActivity.this);
            pDialog.setMessage("Notifying user...");
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "driver_arrived.php?rideId="+ ride_id;
        ...
        protected void onPostExecute(Void result) {
            ...
            Intent mIntent = new Intent(EnrouteRiderActivity.this, WaitForRiderActivity.class);
